...
public class Semantics {
    ...
    Value applyBinary (Operator op, Value v1, Value v2) {
        ...
        throw new IllegalArgumentException("should never reach here : applyBinary");
    }
    ...
    Value applyUnary (Operator op, Value v) {
        ...
        else if (op.val.equals(Operator.FLOAT_NEG) || op.val.equals(Operator.FLOAT_MINUS))
        ...
        throw new IllegalArgumentException("should never reach here : applyUnary " + op.toString());
    }
