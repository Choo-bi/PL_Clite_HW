...
public class StaticTypeCheck {
    ...
    public static void V (Expression e, TypeMap tm) {
        ...
        if(e instanceof Unary) {
            ...
            if(u.op.NotOp()){
                ...
                check(typ==Type.INT, "non-int operand");
            }
            else if(u.op.equals(Operator.INT)){
                check(typ==Type.FLOAT || typ==Type.CHAR, "type error for ");
            }
    ...
    public static void V (Statement s, TypeMap tm) {
        ...
        if(s instanceof Conditional){
            ...
            check(ttType == Type.BOOL, "conditional isn't reasonable");
            V(c.thenbranch, tm);
            V(c.elsebranch, tm);
            return;
        }
        if (s instanceof Loop){
            ...
            check(ttType== Type.BOOL, "Loop isn't reasonable");
            V(l.body, tm);
            return;
        }
